...
import { analyseComplexValue, motion, useInView, useScroll, useTransform } from "framer-motion"
    ...
    return (
        ...
        >
            ...
            <motion.div style={{ y }} className='absolute inset-0 overflow-hidden'>
                ...
                />
                <div className={`absolute bottom-40 right-1/4 w-80 h-80 rounded-full blur-3xl opacity-5 ${isDarkMode ? "bg-puple-500" : "bg-purple-400"}`} />
            </motion.div>
            ...
            <div className='max-w-6xl mx-auto relative z-10'>
                ...
                <div className='grid lg:grid-cols-2 gap-16 items-start'>
                    ...
                    >
                        <motion.div
                            variants={itemVariants}
                            className={`p-8 rounded-2xl border ${isDarkMode ? "bg-gray-800/50 border-gray-700 backdrop-blur-sm" : "bg-gray-50/80 border-gray-20 backdrop-blur-sm"
                                }`}
                        >
                            <h3 className='text-2xl font-medium mb-8'>Send me a message</h3>
                            <div className='space-y-6'>
                                <div className='grid md:grid-cols-2 gap-6'>
                                    <TextInput isDarkMode={isDarkMode} value={formData.name}
                                        handleInputChange={(text) => handleInputChange("name", text)}
                                        label="Your Name"
                                    />
                                    <TextInput isDarkMode={isDarkMode} value={formData.email}
                                        handleInputChange={(text) => handleInputChange("email", text)}
                                        label="Email Address"
                                    />
                                </div>
                                <TextInput isDarkMode={isDarkMode} value={formData.message}
                                    textarea
