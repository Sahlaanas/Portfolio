...
const Footer = () => {
    ...
    const socialLinks = [
        ...
        },
        {
            name: 'Email',
            icon: Mail,
            url: 'mailto:sahlavalillath@gmail.com',
    ...
    const AnimatedGradientLine = () => (
        <div className='absolute top-0  left-0 w-full h-px overflow-hidden'>
            ...
            ></motion.div>
            <motion.div
                className={`absolute top-0 h-px w-32 bg-gradient-to-r ${isDarkMode ? "from-blue-400 via-purple-500 to-blue-400" : "from-blue-500 via-purple-600 to-blue-500"} blur-sm`}
                    ...
                    >
                        ...
                        <motion.div variants={itemVariants} className='space-y-4'>
                            ...
                            >
                                ...
                                <span>Sahla Valillath</span>
                            </motion.div>
                            <motion.p
                            variants={itemVariants}
                            className={`text-sm ${isDarkMode ? "text-gray-400" : "text-gray-600"} max-w-md mx-auto`}
                            >
                                Crafting digital experience with passion, precision and a touch of magic.
                            </motion.p>
                        </motion.div>
                        ...
                        >
                            ...
                            >
                                {new Date().getFullYear()} Math Coder. all rights reserved
                            </p>
                            <p className={`text-xs ${ isDarkMode ? "text-gray-600" : "text-gray-500"}`}> Built with React & Framer Motion + Designed with care</p>
