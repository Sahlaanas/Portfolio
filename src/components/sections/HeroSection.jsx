...
import PROFILE_PIC from '../../assets/images/prof_pic1.png'
                ...
                <div className='max-w-7xl mx-auto w-full z-10 mt-20'>
                    ...
                    <div className='block lg:hidden'>
                        ...
                        >
                            ...
                            >
                            Python FullStack Developer | Data Scientist
                            </motion.div>
                            <motion.h1
                            ...
                            >
                                Specializing in GenAI solutions, data science, and full-stack development with Python and modern frameworks
                            </motion.p>
                            ...
                            <motion.div
                                ...
                                {[
                                    ...
                                    { icon: Mail, href: "mailto:sahlavalillath@gmail.com" },
                                    { icon: LuPhone, href: "" },
                                ].map((social, index) => (
                                    <motion.a
                                        key={index}
                    ...
                    <div className='hidden lg:grid lg:grid-cols-2 lg:gap-16 lg:items-center'>
                        ...
                        <motion.div
                            ...
                            <motion.p
                                variants={itemVariants}
                                className={`text-xl ${isDarkMode ? "text-gray-400" : "text-gray-600"} mb-8 max-w-lg font-light leading-relaxed`}
                            >
                                Specializing in GenAI solutions, data science, and full-stack development with Python and modern frameworks
                            </motion.p>
                            ...
                            <motion.div
                                ...
                                {[
                                    { icon: FiGithub, href: "https://github.com/sahlaanas" },
                                    { icon: FiLinkedin, href: "https://linkedin.com/in/sahlavalillath" },
                                    { icon: Mail, href: "mailto:sahlavalillath@gmail.com" },
                                    { icon: LuPhone, href: "" },
                                ].map((social, index) => (
                                    <motion.a
                        ...
                        <motion.div
                            ...
                            <div className='relative'>
                                <motion.div
                                    variants={itemVariants}
                                    className='flex item-center space-x-8 text-xs uppercase tracking-widest absolute -top-16 -left-15'>
                                    <span className={isDarkMode ? "text-gray-600" : "text-gray-500"}>
                                        Python
                                    </span>
                                    <span className={isDarkMode ? "text-gray-700" : "text-gray-400"}>
