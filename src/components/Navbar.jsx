...
const Navbar = () => {
    ...
    const handleDownloadCV = () => {
        ...
        link.href = '/sahla-cv.pdf'; // Make sure to place your CV in the public folder
        link.download = 'Sahla_V_CV.pdf';
        ...
        >
            <div className="max-w-7xl mx-auto flex items-center justify-between">
                ...
                >
                    <img 
                        src={portfolioLogo } 
                        alt="Sahla Valillath Logo" 
                        className="w-14 h-8"
                    />
                    <span className="text-lg ml-0">Sahla Valillath</span>
                </motion.div>
                ...
                <div className='hidden md:flex items-center space-x-8'>
                    ...
                    <motion.button
                        ...
                        className={`flex items-center space-x-2 text-sm uppercase tracking-wider transition-colors ${isDarkMode ? "text-gray-400 hover:text-white" : "text-gray-600 hover:text-gray-900"}`}>
                        <Download size={16} />
                    ...
                    isMenuOpen && (
                        ...
                        >
                            ...
                            <motion.button
                                whileHover={{ x: 5 }}
                                onClick={handleDownloadCV}
                                className={`flex items-center space-x-2 w-full text-left py-2 text-sm uppercase tracking-wider transition-colors ${isDarkMode ? "text-gray-400 hover:text-white" : "text-gray-600 hover:text-gray-900"} `}
                            >
                                <Download size={16} />
                                <span>Download CV</span>
                            </motion.button>
